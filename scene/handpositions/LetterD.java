...
public class LetterD implements HandPosition {
    ...
    public LetterD() {
        ...
        timeline.addKeyFrame(new HandConfiguration(CONFIG), 5000);
        // Hold Position Two seconds
        timeline.addKeyFrame(new HandConfiguration(CONFIG), 2000);
        // Return to Start
        timeline.addKeyFrame(new HandConfiguration(Neutral.CONFIG), 10000);
    }
