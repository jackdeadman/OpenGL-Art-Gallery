...
public class TwoTriangles4 extends Mesh {
  ...
  public TwoTriangles4(GL3 gl, int[] textureId, Material material) {
    super(gl);
    ...
    if (material == null) {
        super.material.setAmbient(0.5f, 0.5f, 0.5f);
        super.material.setDiffuse(0.1f, 0.1f, 0.1f);
        super.material.setSpecular(0.1f, 0.1f, 0.1f);
  ...
  public TwoTriangles4(GL3 gl, int[] textureId) {
  ...
  public void render(GL3 gl, Mat4 model) {
    ...
    Mat4 mvpMatrix = Mat4.multiply(perspective, Mat4.multiply(camera.getSkyboxViewMatrix(), model));
