...
public class MultiLightTwoTriangles extends TwoTriangles {

    public MultiLightTwoTriangles(GL3 gl, Material material, int[][] textures, String vs, String fs) {
        super(gl);
    }

    public MultiLightTwoTriangles(GL3 gl, Material material, int[] textures) {
        this(gl, textures, material, "shaders/vs_tt_05.txt", "shaders/fs_tt_05.txt");
    }
