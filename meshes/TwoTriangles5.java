...
public class TwoTriangles5 extends Mesh {

  private int[] textureId1;
  private int[] textureId2;
  private int[] textureId3;

  public TwoTriangles5(GL3 gl, int[] textureId1, int[] textureId2, int[] textureId3, String fs) {
    super(gl);
  ...
  public TwoTriangles5(GL3 gl, int[] textureId1, int[] textureId2, int[] textureId3) {
      this(gl, textureId1, textureId2, textureId3, "shaders/fs_tt_05_window_3.txt");
  }
